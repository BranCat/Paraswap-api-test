...
var paraswapCore = require('paraswap-core');
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              !('orders' in params) // when present, destAmount becomes sum(orders[].makerAmount)
                ...
                AmountMistmatchError = side === paraswapCore.SwapSide.SELL ? 'Source Amount Mismatch' : 'Destination Amount Mismatch'; // user provides srcAmount or slippage but not both. so we only validate accordingly.
...
function areAmountsCorrect(_ref3) {
  ...
  if (queryParams.slippage) {
    return side === paraswapCore.SwapSide.BUY && queryParams.destAmount === priceRoute.destAmount || side === paraswapCore.SwapSide.SELL && queryParams.srcAmount === priceRoute.srcAmount;
  } // provided amounts match the previously queried price route


  var _ref4 = side === paraswapCore.SwapSide.SELL ? [queryParams.srcAmount, priceRoute.srcAmount] : [queryParams.destAmount, priceRoute.destAmount],
      inputAmount = _ref4[0],
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              options = _extends({}, _options, {
                includeContractMethods: [paraswapCore.ContractMethod.simpleBuy]
              });
              side = paraswapCore.SwapSide.BUY;
      ...
      return _regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              if (side === void 0) {
                side = paraswapCore.SwapSide.SELL;
              }
...
Object.defineProperty(exports, 'ContractMethod', {
  enumerable: true,
  get: function () { return paraswapCore.ContractMethod; }
});
Object.defineProperty(exports, 'SwapSide', {
  enumerable: true,
  get: function () { return paraswapCore.SwapSide; }
});
...
exports.constructAxiosFetcher = constructFetcher$1;
...
exports.constructFetchFetcher = constructFetcher;
